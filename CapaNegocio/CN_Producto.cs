...
namespace CapaNegocio
{
    public class CN_Producto
    {
        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            if (string.IsNullOrEmpty(obj.NomProducto) || string.IsNullOrWhiteSpace(obj.NomProducto))
            {
                Mensaje = "El nombre del producto no puede ser vacio";
            }
            else if (string.IsNullOrEmpty(obj.DesProducto) || string.IsNullOrWhiteSpace(obj.DesProducto)) 
            {
